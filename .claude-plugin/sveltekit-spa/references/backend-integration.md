...
func handleError(c echo.Context, status int, message string, details map[string]string) error {
...
func getUser(c echo.Context) error {
	...
	if err == sql.ErrNoRows {
		return handleError(c, http.StatusNotFound, "User not found", nil)
	}
	if err != nil {
		return handleError(c, http.StatusInternalServerError, "Database error", nil)
	}
